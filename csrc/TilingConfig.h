...
#define TILE_K (MMA_K * BLOCK_K_TENSORS)  // 32 or 64
#define METADATA_PER_TENSOR 8
...
#define HALF_PER_SHMEM_BANK 64
#define REG_PER_C_TENSOR_16_16 4  // 8 for FP32 Accumulation; 4 for FP16 Accumulation

#define PADDING_SHARED_MEM_FOR_C 0  // Padding 8/2 float each column to eliminating bank-conflict in C fragments

#define FINE_VECTOR_SIZE 8
...
#define TILE_M (MMA_M * (WARP_ROW_TENSORS * BLOCK_ROW_WARPS))
...
struct TilingConfig {
    ...
    // fine-grain vector size
    static constexpr int VECTOR_SIZE = 8;
//    typedef typename TypeUtils<8>::vector_type vector_type;
};
